      ...
      <div ref={ref} className="px-6 md:px-12 lg:px-20">
        <div className="max-w-6xl mx-auto">
          ...
          <motion.h2
            ...
            className="heading-section text-foreground mb-12 max-w-4xl"
          >
          ...
          >
            <a
              href="#contact"
              className="inline-block px-10 py-5 bg-primary text-primary-foreground font-medium uppercase tracking-wider text-sm hover:bg-green-glow transition-colors"
            >
              Contact Us
            </a>
          </motion.div>
